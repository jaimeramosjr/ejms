...
export function CustomDatatable({ fields, data, onRowClicked, onRowSelected, objectKey ,onRowChecked })
{
 ...
 columns[3] = 
  {
    ...
    cell: row => 
       ...
       <div>  { row.customer ? row.customer.customerName1  : '---' }</div>
   ...
   columns[10] = 
  {
    ...
    cell: row => 
       ...
       <div>  { row.customer ? row.customer.street + row.customer.city + row.customer.province : '---' }</div>
